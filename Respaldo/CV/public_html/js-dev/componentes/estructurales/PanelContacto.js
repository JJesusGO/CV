...
class PanelContacto extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            formulario: null,
            perfiles:[
                {icono:"/media/img/icono-llamame.svg",titulo:"Llamame",descripcion:"(462) 211 0468"},
                {icono:"/media/img/icono-wa.svg",titulo:"WhatsApp",descripcion:"(462) 211 0468"},
                {icono:"/media/img/icono-correo.svg",titulo:"Mandame un correo",descripcion:"jdj.gutierrezornelas@hotmail.com"},
            ],
            opciones:[
                "Desarrollo web",
